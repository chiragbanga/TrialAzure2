...
host_server = os.environ.get('host_server', 'cbangafastapi.mysql.database.azure.com')
...
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'cbangafastapi@cbangafastapi')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', 'cbanga@12')))
